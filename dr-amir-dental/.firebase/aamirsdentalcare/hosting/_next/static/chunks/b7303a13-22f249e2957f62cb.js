"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[726],{2686:function(e,t,n){n.d(t,{ET:function(){return sA},IO:function(){return si},JU:function(){return iL},PL:function(){return sE},QT:function(){return sw},Xo:function(){return su},ad:function(){return iF},ar:function(){return sa},cf:function(){return sS},hJ:function(){return ix},oe:function(){return sC},pl:function(){return sT},r7:function(){return sI}});var r,i,s,a,o=n(9995),l=n(2826),u=n(7037),c=n(9966),h=n(1215),d=n(518);n(4417);var f=n(5705).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class i6{get id(){return this._key.path.lastSegment()}get ref(){return new iD(this._firestore,this._converter,this._key)}exists(){return null!==this._document}data(){if(this._document){if(this._converter){let e=new i7(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){let t=this._document.data.field(se("DocumentSnapshot.get",e));if(null!==t)return this._userDataWriter.convertValue(t)}}constructor(e,t,n,r,i){this._firestore=e,this._userDataWriter=t,this._key=n,this._document=r,this._converter=i}}class i7 extends i6{data(){return super.data()}}function se(e,t){return"string"==typeof t?i9(e,t):t instanceof iq?t._internalPath:t._delegate._internalPath}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sg{isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}}class sp extends i6{exists(){return super.exists()}data(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};if(this._document){if(this._converter){let t=new sy(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};if(this._document){let n=this._document.data.field(se("DocumentSnapshot.get",e));if(null!==n)return this._userDataWriter.convertValue(n,t.serverTimestamps)}}constructor(e,t,n,r,i,s){super(e,t,n,r,s),this._firestore=e,this._firestoreImpl=e,this.metadata=i}}class sy extends sp{data(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};return super.data(e)}}class sv{get docs(){let e=[];return this.forEach(t=>e.push(t)),e}get size(){return this._snapshot.docs.size}get empty(){return 0===this.size}forEach(e,t){this._snapshot.docs.forEach(n=>{e.call(t,new sy(this._firestore,this._userDataWriter,n.key,n,new sg(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))})}docChanges(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new A(C.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(e,t){if(e._snapshot.oldDocs.isEmpty()){let t=0;return e._snapshot.docChanges.map(n=>{let r=new sy(e._firestore,e._userDataWriter,n.doc.key,n.doc,new sg(e._snapshot.mutatedKeys.has(n.doc.key),e._snapshot.fromCache),e.query.converter);return n.doc,{type:"added",doc:r,oldIndex:-1,newIndex:t++}})}{let n=e._snapshot.oldDocs;return e._snapshot.docChanges.filter(e=>t||3!==e.type).map(t=>{let r=new sy(e._firestore,e._userDataWriter,t.doc.key,t.doc,new sg(e._snapshot.mutatedKeys.has(t.doc.key),e._snapshot.fromCache),e.query.converter),i=-1,s=-1;return 0!==t.type&&(i=n.indexOf(t.doc.key),n=n.delete(t.doc.key)),1!==t.type&&(s=(n=n.add(t.doc)).indexOf(t.doc.key)),{type:function(e){switch(e){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return I()}}(t.type),doc:r,oldIndex:i,newIndex:s}})}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}constructor(e,t,n,r){this._firestore=e,this._userDataWriter=t,this._snapshot=r,this.metadata=new sg(r.hasPendingWrites,r.fromCache),this.query=n}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sw(e){e=iS(e,iD);let t=iS(e.firestore,iO);return(function(e,t){let n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{},r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new id({next:o=>{s.Za(),t.enqueueAndForget(()=>rq(e,a));let l=o.docs.has(n);!l&&o.fromCache?i.reject(new A(C.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&o.fromCache&&r&&"server"===r.source?i.reject(new A(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(o)},error:e=>i.reject(e)}),a=new rQ(e5(n.path),s,{includeMetadataChanges:!0,_a:!0});return rU(e,a)})(await iw(e),e.asyncQueue,t,n,r)),r.promise})(iP(t),e._key).then(n=>sk(t,e,n))}class s_ extends sf{convertBytes(e){return new iU(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iD(this.firestore,null,t)}constructor(e){super(),this.firestore=e}}function sE(e){e=iS(e,ib);let t=iS(e.firestore,iO),n=iP(t),r=new s_(t);return st(e._query),(function(e,t){let n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{},r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new id({next:n=>{s.Za(),t.enqueueAndForget(()=>rq(e,a)),n.fromCache&&"server"===r.source?i.reject(new A(C.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),a=new rQ(n,s,{includeMetadataChanges:!0,_a:!0});return rU(e,a)})(await iw(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new sv(t,r,e,n))}function sT(e,t,n){e=iS(e,iD);let r=iS(e.firestore,iO),i=sm(e.converter,t,n);return sN(r,[iJ(iX(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,tx.none())])}function sI(e,t,n){for(var r=arguments.length,i=Array(r>3?r-3:0),s=3;s<r;s++)i[s-3]=arguments[s];e=iS(e,iD);let a=iS(e.firestore,iO),o=iX(a);return sN(a,[("string"==typeof(t=(0,c.m9)(t))||t instanceof iq?function(e,t,n,r,i,s){let a=e.Qu(1,t,n),o=[i3(t,r,n)],l=[i];if(s.length%2!=0)throw new A(C.INVALID_ARGUMENT,"Function ".concat(t,"() needs to be called with an even number of arguments that alternate between field names and values."));for(let e=0;e<s.length;e+=2)o.push(i3(t,s[e])),l.push(s[e+1]);let u=[],h=eO.empty();for(let e=o.length-1;e>=0;--e)if(!i5(u,o[e])){let t=o[e],n=l[e];n=(0,c.m9)(n);let r=a.Nu(t);if(n instanceof iZ)u.push(t);else{let e=i$(n,r);null!=e&&(u.push(t),h.set(t,e))}}return new ij(h,new eo(u),a.fieldTransforms)}(o,"updateDoc",e._key,t,n,i):function(e,t,n,r){let i=e.Qu(1,t,n);i2("Data must be an object, but it was:",i,r);let s=[],a=eO.empty();return ee(r,(e,r)=>{let o=i9(t,e,n);r=(0,c.m9)(r);let l=i.Nu(o);if(r instanceof iZ)s.push(o);else{let e=i$(r,l);null!=e&&(s.push(o),a.set(o,e))}}),new ij(a,new eo(s),i.fieldTransforms)}(o,"updateDoc",e._key,t)).toMutation(e._key,tx.exists(!0))])}function sC(e){return sN(iS(e.firestore,iO),[new tK(e._key,tx.none())])}function sA(e,t){let n=iS(e.firestore,iO),r=iL(e),i=sm(e.converter,t);return sN(n,[iJ(iX(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,tx.exists(!1))]).then(()=>r)}function sS(e){let t,n,r;for(var i,s,a,o=arguments.length,l=Array(o>1?o-1:0),u=1;u<o;u++)l[u-1]=arguments[u];e=(0,c.m9)(e);let h={includeMetadataChanges:!1,source:"default"},d=0;"object"!=typeof l[0]||iM(l[d])||(h=l[d],d++);let f={includeMetadataChanges:h.includeMetadataChanges,source:h.source};if(iM(l[d])){let e=l[d];l[d]=null===(i=e.next)||void 0===i?void 0:i.bind(e),l[d+1]=null===(s=e.error)||void 0===s?void 0:s.bind(e),l[d+2]=null===(a=e.complete)||void 0===a?void 0:a.bind(e)}if(e instanceof iD)n=iS(e.firestore,iO),r=e5(e._key.path),t={next:t=>{l[d]&&l[d](sk(n,e,t))},error:l[d+1],complete:l[d+2]};else{let i=iS(e,ib);n=iS(i.firestore,iO),r=i._query;let s=new s_(n);t={next:e=>{l[d]&&l[d](new sv(n,s,i,e))},error:l[d+1],complete:l[d+2]},st(e._query)}return function(e,t,n,r){let i=new id(r),s=new rQ(t,i,n);return e.asyncQueue.enqueueAndForget(async()=>rU(await iw(e),s)),()=>{i.Za(),e.asyncQueue.enqueueAndForget(async()=>rq(await iw(e),s))}}(iP(n),r,f,t)}function sN(e,t){return function(e,t){let n=new S;return e.asyncQueue.enqueueAndForget(async()=>r3(await iv(e).then(e=>e.syncEngine),t,n)),n.promise}(iP(e),t)}function sk(e,t,n){let r=n.docs.get(t._key),i=new s_(e);return new sp(e,i,t._key,r,new sg(n.hasPendingWrites,n.fromCache),t.converter)}new WeakMap,function(){let e=!(arguments.length>1)||void 0===arguments[1]||arguments[1];p=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,n)=>{let{instanceIdentifier:r,options:i}=n,s=t.getProvider("app").getImmediate(),a=new iO(new D(t.getProvider("auth-internal")),new V(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new A(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ev(e.options.projectId,t)}(s,r),s);return i=Object.assign({useFetchStreams:e},i),a._setSettings(i),a},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(m,"4.7.3",void 0),(0,o.KN)(m,"4.7.3","esm2017")}()}}]);